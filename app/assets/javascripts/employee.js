...
$(document).on('ready page:load', function() {
  return CountryStateSelect({
    country_id: "employee_nazioneNascita",
    state_id: "employee_regione",
    city_id: "employee_luogoNascita"
  });
});

$(document).on('ready page:load', function() {
  return CountryStateSelect({
    country_id: "employee_nazioneResidenza",
    state_id: "employee_regioneResidenza",
    city_id: "employee_cittaResidenza"
  });
});
